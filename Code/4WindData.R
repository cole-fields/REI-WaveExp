...
u10 <- map(era5, ~as.vector(ncvar_get(.x, 'u_wind')))
v10 <- map(era5, ~as.vector(ncvar_get(.x, 'v_wind')))

latitude <- map(era5, ~as.vector(ncvar_get(.x, 'nav_lat'))) 

longitude <- map(era5, ~as.vector(ncvar_get(.x, 'nav_lon')))
